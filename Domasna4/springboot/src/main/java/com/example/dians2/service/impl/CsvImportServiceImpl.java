...
public class CsvImportServiceImpl implements CsvImportService {
    private static CsvImportServiceImpl instance;
    @Autowired
    ...
    private CsvImportServiceImpl(IssuerDataRepository issuerDataRepository, CodeServiceImpl codeService) {
        this.issuerDataRepository = issuerDataRepository;
        this.codeService = codeService;
    }

    public static synchronized CsvImportServiceImpl getInstance(IssuerDataRepository issuerDataRepository, CodeServiceImpl codeService) {
        if (instance == null) {
            instance = new CsvImportServiceImpl(issuerDataRepository, codeService);
        }
        return instance;
    }
