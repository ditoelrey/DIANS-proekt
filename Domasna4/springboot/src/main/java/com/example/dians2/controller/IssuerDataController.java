...
@Autowired
public IssuerDataController(CodeRepository codeRepository, IssuerDataRepository issuerDataRepository,TechnicalAnalysisServiceImpl technicalAnalysisService) {
    this.codeService = CodeServiceImpl.getInstance(codeRepository, issuerDataRepository);
    this.issuerService = IssuerDataServiceImpl.getInstance(issuerDataRepository);
