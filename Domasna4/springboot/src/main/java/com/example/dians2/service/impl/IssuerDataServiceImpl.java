...
public class IssuerDataServiceImpl implements IssuerDataService {
    private static IssuerDataServiceImpl instance;
    ...
    public static synchronized IssuerDataServiceImpl getInstance(IssuerDataRepository issuerDataRepository) {
        if (instance == null) {
            instance = new IssuerDataServiceImpl(issuerDataRepository);
        }
        return instance;
    }
